...
public class ListeMois{
    ...
    public ListeMois(){
        ...
        Evenement OpenSession = new Evenement(17, 2, "Open Session Chorale", "Amphi 210", "Venez découvrir le CLub Chorale", 0);
        Jour j2 = new Jour(true, 27, 10, 2022);
        Evenement CoursSolfege = new Evenement(18, 2, "Apprenez à lire une partition !", "Amphi 110", "Cours de musique pour débutants", 4);

        Jour j3 = new Jour(true, 17, 11, 2022);

        Jour j4 = new Jour(true, 10, 12, 2022);
        Evenement jpo = new Evenement(13, 4, "JPO", "ESIEE", "Journée Portes Ouvertes de l'ESIEE", 0);
        Jour j5 = new Jour(true, 6, 12, 2022);
        Evenement blindtest = new Evenement(19, 2, "BlindTest", "Foyer", "BlindTest par le Club Foyer et le Club Chorale", 0);
        Jour j6 = new Jour(true, 12, 12, 2022);
        Evenement StandNoel = new Evenement(9, 8, "Stand Marché de Noël", "En face du MD", "Le Club Musique tiendra son stand de Noël toute la journée à l'occasion de la semaine de Noël à l'ESIEE", 0);
        Evenement jam = new Evenement(19, 4, "Jam Session", "Studio Musique", "Jam organisée par le Club Musique", 0);
        Jour j7 = new Jour(true, 16, 12, 2022);
        Evenement presentation = new Evenement(13, 4, "Presentation des applications", "4201", "Les eleves de E4FE présentent leur application Android", 0);

        Jour j8 = new Jour(true, 2, 1, 2023);
        Evenement rentree = new Evenement(8, 10, "Rentrée", "ESIEE", "Rentrée des élèves", 0);
