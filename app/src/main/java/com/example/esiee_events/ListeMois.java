...
public class ListeMois{
    ...
    public ListeMois(){
        ...
        Evenement karaoke = new Evenement(true, 6, 11, 2022, 18, 2, "Karaoke", "Amphi 210", "Karaoke organisé par le Club Chorale", 5);
        Jour j2 = new Jour(true, 15, 11, 2022);
        Evenement jpo = new Evenement(true, 15, 11, 2022, 13, 4, "JPO", "ESIEE", "JPO", 0);
        Jour j3 = new Jour(true, 15, 11, 2022);
        Evenement blindtest = new Evenement(true, 15, 11, 2022, 19, 1, "BlindTest", "Foyer", "Blindtest organisé au foyer", 0);
